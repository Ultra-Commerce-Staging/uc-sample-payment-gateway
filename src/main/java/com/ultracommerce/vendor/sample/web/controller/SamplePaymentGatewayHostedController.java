 ...
 */
@Controller("ucSamplePaymentGatewayHostedController")
@RequestMapping("/" + SamplePaymentGatewayHostedController.GATEWAY_CONTEXT_KEY)
public class SamplePaymentGatewayHostedController extends PaymentGatewayAbstractController {

    protected static final Log LOG = LogFactory.getLog(SamplePaymentGatewayHostedController.class);
