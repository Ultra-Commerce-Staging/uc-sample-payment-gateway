...
@Controller("ucSamplePaymentGatewayCustomerPaymentController")
@RequestMapping("/" + SamplePaymentGatewayCustomerPaymentController.GATEWAY_CONTEXT_KEY)
public class SamplePaymentGatewayCustomerPaymentController extends CustomerPaymentGatewayAbstractController {
